...
static const D3DXVECTOR4 FALLOFF_PARAM(30.0f, 0.7f, 0.2f, 0.15f);
static const D3DXVECTOR4 SPOTLIGHT_PARAM(0.01f, cosf(D3DXToRadian(90.0f) / 2.0f), 1.0f / (cosf(D3DXToRadian(70.0f) / 2.0f) - cosf(D3DXToRadian(10.0f) / 2.0f)), 1.0f);
